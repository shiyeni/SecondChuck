...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SecondChuckNorrisApp1.Android.dll" comes first in this list. */
		"SecondChuckNorrisApp1.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"SecondChuckNorrisApp1.dll",
